    ...
    <div class="row">
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-4">
            <div class="card">
                ...
                <div class="card-body">
            <form method="POST" action="/admin/all-plan-one/{{$benefitsOne->id}}">
                @csrf
                {{-- @method('PUT') --}}
                <div class="form-group py-2">
                    <label for="inputbenefit">Benefit</label>
                    <input id="inputcourseimg" type="text" class="form-control " name="benefit" value="{{ old('benefit', $benefitsOne->benefit) }}"  autofocus placeholder="Benefit">
                </div>
                <div class="form-group py-2">
