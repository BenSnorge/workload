...
@section('content')
    <div class="checkout">
   <div class="container">
    <form class="col-lg-6 mx-auto" method="POST" action="{{ route('monthly.store') }}" id="monthly-form">
            @csrf
      <h3 class="mb-3">Subscribe to Monthly Plan</h3>
  ...
  <script>
        ...
        const paymentForm = document.getElementById('monthly-form');
